        ...
        <div>
            <form runat="server" method="post">
                ...
                <center>
                    ...
                    <br />
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" DataSourceID="SqlDataSource1" AutoGenerateColumns="False">
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:restaurantConnectionString %>' SelectCommand="SELECT * FROM [tbl_Booking]">
                    </asp:SqlDataSource>
                </center>
